...
?>  
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          ...
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.twitter.com/"><i class="fab fa-twitter"></i> Twitter</a>
          </div>
          <!-- <div class="col-sm">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>iSchool Pvt Ltd <br> Near ASP College  <br> Devrukh, Ratnagiri <br> Ph. 9403247568 </p>
          </div>
        </div>
      </div>
